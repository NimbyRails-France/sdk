// Candidate VA 140441780; RVA 0x441780
// Ghidra inferred prototype: undefined FUN_140441780()

void FUN_140441780(undefined8 param_1,longlong param_2,undefined8 *param_3,undefined4 *param_4)

{
  ...
  if (((param_2 != 0) && (param_3 != (undefined8 *)0x0)) && (param_4 != (undefined4 *)0x0)) {
    ...
    *(undefined2 *)((longlong)puVar7 + 0x26) = 0;
    puVar7[2] = 0;
    puVar7[3] = 0;
    *puVar7 = nimby::model::SimCmd::TrainSetMilestone::vftable;
...
// Incoming references
// 0xc23138 DATA caller none
// 0xb075a8 DATA caller none
// 0xb075b8 DATA caller none
// 0x453785 DATA caller 140452f40
