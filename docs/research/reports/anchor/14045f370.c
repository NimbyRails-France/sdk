...
longlong * FUN_14045f370(longlong *param_1,longlong *param_2)

{
  ...
  *param_1 = (longlong)&DAT_140a6d430;
  ...
  while (cVar2 < -1) {
    ...
    puVar31 = puVar31 + (ulonglong)uVar5 * 2;
    cVar2 = *pcVar27;
  }
  lVar6 = param_2[3];
  lVar4 = *param_2;
  while (pcVar27 != (char *)(lVar6 + lVar4)) {
    ...
    *(byte *)((uVar29 - 0x10 & param_1[3]) + (ulonglong)((uint)param_1[3] & 0xf) + 1 + *param_1) =
         bVar26;
    lVar28 = param_1[1];
    *(ulonglong *)(lVar28 + uVar29 * 0x10) = *puVar31;
    *(ulonglong *)(lVar28 + 8 + uVar29 * 0x10) = puVar31[1];
    pcVar27 = pcVar27 + 1;
    puVar31 = puVar31 + 2;
    cVar2 = *pcVar27;
    while (cVar2 < -1) {
