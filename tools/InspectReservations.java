...
public class InspectReservations extends GhidraScript {
    ...
    public void run() throws Exception {
        ...
        while (data.hasNext()) {
            ...
            if (!(lower.contains("speed") || lower.contains("train") || lower.contains("dynamics") || lower.contains("motion") ||
                ...
                lower.contains("balise") || lower.contains("beacon") || lower.contains("position") || lower.contains("reserv") || lower.contains("occup") || lower.contains("probe") || lower.contains("trace"))) continue;
