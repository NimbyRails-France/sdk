...
public class InspectSimulationClock extends GhidraScript {
    ...
    public void run() throws Exception {
        ...
        while (data.hasNext()) {
            ...
            if (!(lower.contains("clock") || lower.contains("date") || lower.contains("calendar") || lower.contains("epoch") || lower.contains("time") || lower.contains("warp") || lower.contains("cheat"))) continue;
