// Candidate VA 1407cde80; RVA 0x7cde80
// Ghidra inferred prototype: undefined FUN_1407cde80()

longlong FUN_1407cde80(longlong param_1,longlong param_2,longlong param_3,undefined8 param_4,
...
LAB_1407ce122:
    ...
    lVar29 = lVar18 * 2;
    if (lVar29 != 0) goto LAB_1407ce122;
    _Dst = (uint *)0x0;
    lVar18 = lVar18 << 3;
    puVar28 = local_178;
  }
...
LAB_1407ce1ad:
  ...
  FUN_140790c40(param_18[3],local_258);
  ...
  if (iVar25 != 0) {
    ...
    FUN_140790c40(param_18[3],local_308);
...
// Incoming references
// 0xc3a61c DATA caller none
// 0x7c896d UNCONDITIONAL_CALL caller 1407c87f0
