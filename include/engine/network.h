...
struct Signal { uint64_t id{}, track_id{}; double fraction{}; int direction{}, kind{}; uint64_t textures_hash{}; };
...
struct Network { std::vector<NimbyPlatform> platforms; std::vector<Track> tracks; std::vector<Station> stations; std::vector<Signal> signals; };
