...
import java.util.*;
public class InspectClockOffsets extends GhidraScript {
 public void run() throws Exception {
  ...
  while(iter.hasNext()){
   ...
   if(va<0x140430000L||va>=0x140490000L)continue;
   for(int i=0;i<ins.getNumOperands();i++)for(Object o:ins.getOpObjects(i))
    if(o instanceof Scalar){long v=((Scalar)o).getUnsignedValue();if(v==0x4b8||v==0x5c0||v==0x630){
